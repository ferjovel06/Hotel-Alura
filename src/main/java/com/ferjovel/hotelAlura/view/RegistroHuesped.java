...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHuesped() {
		...
		Huesped nuevoHuesped = new Huesped(txtNombre.getText(), txtApellido.getText(), 
				Date.valueOf(fechaNac), txtNacionalidad.getSelectedItem().toString(), 
				txtTelefono.getText(), nReserva);
		this.huespedesController.guardar(nuevoHuesped);
