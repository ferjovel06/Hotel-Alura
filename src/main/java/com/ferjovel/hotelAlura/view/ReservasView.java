...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		JLabel continuarNewLabel = new JLabel("Continuar");
		continuarNewLabel.setBounds(0, 0, 122, 36);
		btnsiguiente.add(continuarNewLabel);
		continuarNewLabel.setForeground(SystemColor.controlLtHighlight);
		continuarNewLabel.setHorizontalAlignment(SwingConstants.CENTER);
		continuarNewLabel.setFont(new Font("Roboto", Font.PLAIN, 18));
	...
	private void guardarReserva() {
		...
		Reserva nuevaReserva = new Reserva(Date.valueOf(fechaEntrada), Date.valueOf(fechaSalida), txtValor.getText(),
